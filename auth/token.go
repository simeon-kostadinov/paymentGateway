...
func CreateToken(merchant_id uint32) (string, error) {
...
//TokenValid validates the token from the request 
...
func ExtractTokenID(r *http.Request) (uint32, error) {
	...
	if ok && token.Valid {
		mid, err := strconv.ParseUint(fmt.Sprintf("%.0f", claims["merchant_id"]), 10, 32)
		if err != nil {
			return 0, err
		}
